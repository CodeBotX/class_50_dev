...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scores', models.IntegerField(blank=True, null=True, verbose_name=models.FloatField())),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ManyToManyField(blank=True, related_name='subjects', to='SM.subject')),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
